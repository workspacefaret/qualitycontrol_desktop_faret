...
namespace QualityControlCenter.Modules.RegistrosProduccion
{
    public class RegistrosProduccionRepository
    {
        ...
        private async Task CargarCumplimientoPorInspector(
            ...
            RegistrosProduccionResumenDto result,
            string filtros
        )
        {
            ...
            while (await reader.ReadAsync())
            {
                ...
                result.CumplimientoPorInspector.Add(
                    new RegistrosProduccionInspectorDto
                    {
        ...
        )
        {
            ...
            while (await reader.ReadAsync())
            {
                result.ControlesPorProceso.Add(
                    new RegistrosProduccionProcesoInspectorDto
                    {
        ...
        )
        {
            ...
            while (await reader.ReadAsync())
            {
                ...
                result.TendenciaCumplimiento.Add(
                    new RegistrosProduccionTendenciaDto
                    {
        ...
        )
        {
            ...
            while (await reader.ReadAsync())
            {
                ...
                result.DesempenoIndividual.Add(
                    new RegistrosProduccionDesempenoInspectorDto
                    {
                        Inspector = Text(reader, "inspector"),
        ...
        public async Task<RegistrosProduccionFiltrosDto> ObtenerFiltros()
        {
            var result = new RegistrosProduccionFiltrosDto();
            ...
            )
            {
                ...
                {
                    result.Usuarios.Add(
                        new RegistrosProduccionCatalogoDto
                        {
        ...
        public async Task ValidarTodo()
        {
            ...
            using var cmd = new MySqlCommand(
                ...
                SET
                    ...
                    fecha_validacion = NOW(),
                    usuario_validacion = 'SUPERVISOR'
                WHERE UPPER(IFNULL(area, '')) = 'PRODUCCION';
                ",
                conn
            );

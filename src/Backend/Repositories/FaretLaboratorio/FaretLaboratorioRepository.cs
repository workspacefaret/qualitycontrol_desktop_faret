...
namespace QualityControlCenter.Repositories.FaretLaboratorio
{
    public class FaretLaboratorioRepository
    {
        private readonly DbService _db;

        public FaretLaboratorioRepository(DbService db)
        {
            _db = db;
        }

        // Crea la muestra vinculada desde Control de Recepción - Calidad (empresa FARET) — mismo
        // mecanismo que RecepcionCalidadRepository.CrearMuestraLaboratorio (INNPACK), pero
        // escribiendo en faret_muestra_laboratorio en vez de muestra_laboratorio. El caller
        // (RecepcionCalidadRepository) sigue siendo dueño de actualizar
        // recepcion_lotes_control.estado='EnAnalisis' (tabla compartida entre ambas empresas).
        public async Task<int> CrearMuestraDesdeLoteRecepcion(int loteId, int? usuarioId, string? usuarioNombre)
        {
            ...
            // Faret solo tiene habilitado el tipo "Bobina" por ahora (ver RecepcionCalidadHandler),
            // así que tipoMuestra siempre resuelve a "Papel" en la práctica — el switch se deja
            // igual que el de INNPACK por si se habilitan más tipos más adelante.
            ...
            using var cmd2 = new MySqlCommand(
                @"INSERT INTO faret_muestra_laboratorio
            ...
            cmd2.Parameters.AddWithValue("@analistaId", (object?)usuarioId ?? DBNull.Value);
            cmd2.Parameters.AddWithValue("@analistaNombre", (object?)usuarioNombre ?? DBNull.Value);
            cmd2.Parameters.AddWithValue("@tipoMuestra", tipoMuestra);
            cmd2.Parameters.AddWithValue("@codigo", itemCode);
            cmd2.Parameters.AddWithValue("@descripcion", descripcion);
            cmd2.Parameters.AddWithValue("@proveedor", proveedor);
            cmd2.Parameters.AddWithValue("@lote", loteProveedor);
            cmd2.Parameters.AddWithValue("@loteId", loteId);
            cmd2.Parameters.AddWithValue("@creadoPor", (object?)usuarioNombre ?? DBNull.Value);

            return Convert.ToInt32(await cmd2.ExecuteScalarAsync());
        }
        ...
        public async Task<List<MuestraListItemDto>> Listar(string? estado, string? tipoMuestra, string? np)
        {
            ...
            cmd.CommandText =
                $@"SELECT
                    ...
                    (SELECT COUNT(*) FROM faret_muestra_laboratorio_ensayos e WHERE e.muestra_id = m.id AND e.estado <> 'Anulado') AS total_ensayos
                FROM faret_muestra_laboratorio m
            ...
            using (
                var cmd = new MySqlCommand(
                    @"SELECT id, tipo_ensayo, metodo, analista_nombre, fecha, estado,
                      ...
                      FROM faret_muestra_laboratorio_ensayos WHERE muestra_id = @id ORDER BY fecha ASC",
                    conn
                )
            )
            {
        ...
        public async Task<int> GuardarHumedad(HumedadGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_humedad
        ...
        public async Task<int> GuardarGramaje(GramajeGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_gramaje
        ...
        public async Task<int> GuardarCobb(CobbGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_cobb
                        (ensayo_id,
        ...
        public async Task<int> GuardarEspesor(EspesorGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_espesor
        ...
        public async Task<int> GuardarResistencia(string tipoEnsayo, ResistenciaGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_resistencia
        ...
        public async Task<int> GuardarEct(EctGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_ect
        ...
        public async Task<int> GuardarBctMedido(BctMedidoGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_bct_medido
        ...
        public async Task<int> GuardarBctTeorico(BctTeoricoGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"SELECT e.promedio_strength_lbf_m FROM faret_muestra_laboratorio_ect e
                      INNER JOIN faret_muestra_laboratorio_ensayos en ON en.id = e.ensayo_id
            ...
            using (
                var cmd = new MySqlCommand(
                    @"SELECT e.promedio FROM faret_muestra_laboratorio_espesor e
                      INNER JOIN faret_muestra_laboratorio_ensayos en ON en.id = e.ensayo_id
                      WHERE e.ensayo_id=@id AND en.muestra_id=@muestraId AND en.estado='Finalizado'",
                    conn
                )
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_bct_teorico
        ...
        public async Task<int> GuardarViscosidad(ViscosidadGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_viscosidad
        ...
        public async Task<int> GuardarPh(PhGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_ph (ensayo_id, valor_texto, valor_numerico, color_observado)
        ...
        public async Task<int> GuardarSolidos(SolidosGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_solidos
                        (ensayo_id,
        ...
        public async Task<int> GuardarLugol(LugolGuardarRequest r)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_lugol (ensayo_id, punto_muestra, coloracion, resultado, interpretacion)
            ...
            using (
                var cmd = new MySqlCommand(
                    "UPDATE faret_muestra_laboratorio_ensayos SET estado='Finalizado', cumplimiento=@cumplimiento WHERE id=@id",
                    conn
                )
            )
            {
        ...
        public async Task<List<EspecificacionDto>> ListarEspecificaciones()
        {
            ...
            using var cmd = new MySqlCommand(
                @"SELECT id, tipo_muestra, tipo_ensayo, codigo_producto, limite_min, limite_max, unidad, activo
                  FROM faret_muestra_laboratorio_especificaciones
        ...
        public async Task<int> GuardarEspecificacion(GuardarEspecificacionRequest r)
        {
            ...
            {
                using var cmd = new MySqlCommand(
                    @"UPDATE faret_muestra_laboratorio_especificaciones
            ...
            {
                using var cmd = new MySqlCommand(
                    @"INSERT INTO faret_muestra_laboratorio_especificaciones
        ...
        public async Task CambiarActivoEspecificacion(int id, bool activo)
        {
            ...
            using var cmd = new MySqlCommand(
                "UPDATE faret_muestra_laboratorio_especificaciones SET activo=@activo WHERE id=@id",
                conn
            );
        ...
        public async Task AnularEnsayo(int ensayoId, string motivo)
        {
            ...
            int muestraId;
            using (var cmd = new MySqlCommand("SELECT muestra_id FROM faret_muestra_laboratorio_ensayos WHERE id = @id", conn))
            {
                cmd.Parameters.AddWithValue("@id", ensayoId);
                var result = await cmd.ExecuteScalarAsync();
                if (result == null)
            ...
            using (
                var cmd = new MySqlCommand(
                    "UPDATE faret_muestra_laboratorio_ensayos SET estado='Anulado', motivo_anulacion=@motivo WHERE id=@id",
                    conn
                )
            )
            {
        ...
        public async Task<bool> ReemplazarEnsayo(int ensayoOriginalId, int ensayoNuevoId, string motivo)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    "SELECT muestra_id, estado FROM faret_muestra_laboratorio_ensayos WHERE id=@id",
                    conn
                )
            )
            {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"UPDATE faret_muestra_laboratorio_ensayos
        ...
        public async Task<(int Id, string Codigo)> CrearNoConformidad(int muestraId, string? usuarioNombre)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    @"SELECT evaluacion, tipo_muestra, np, cliente, codigo_producto, descripcion,
                             observacion, nc_id
                      FROM faret_muestra_laboratorio WHERE id=@id",
                    conn
                )
            )
            {
            ...
            using (var cmd = new MySqlCommand("UPDATE faret_muestra_laboratorio SET nc_id=@ncId WHERE id=@id", conn))
            {
        ...
        {
            using var cmd = new MySqlCommand(
                @"INSERT INTO faret_muestra_laboratorio_ensayos
        ...
        )
        {
            ...
            if (resultado.HasValue)
            {
                ...
                using (
                    var cmd = new MySqlCommand(
                        "SELECT tipo_muestra, codigo_producto FROM faret_muestra_laboratorio WHERE id=@id",
                        conn
                    )
                )
                {
        ...
        {
            using var cmd = new MySqlCommand(
                @"SELECT limite_min, limite_max, unidad FROM faret_muestra_laboratorio_especificaciones
        ...
        private static async Task RecalcularEvaluacionMuestra(MySqlConnection conn, int muestraId)
        {
            ...
            using (
                var cmd = new MySqlCommand(
                    "SELECT estado, cumplimiento FROM faret_muestra_laboratorio_ensayos WHERE muestra_id=@id AND estado <> 'Anulado'",
                    conn
                )
            )
            {
            ...
            using var updCmd = new MySqlCommand(
                "UPDATE faret_muestra_laboratorio SET estado=@estado, evaluacion=@evaluacion WHERE id=@id",
                conn
            );
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_humedad WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_gramaje WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_cobb WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_espesor WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_resistencia WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_ect WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_bct_medido WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_bct_teorico WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_viscosidad WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_ph WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_solidos WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
        ...
        {
            using var cmd = new MySqlCommand("SELECT * FROM faret_muestra_laboratorio_lugol WHERE ensayo_id=@id", conn);
            cmd.Parameters.AddWithValue("@id", ensayoId);
            using var reader = await cmd.ExecuteReaderAsync();
            if (!await reader.ReadAsync())
                return null;
